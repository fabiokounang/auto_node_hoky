module.exports = (data) => {
  let query = `SELECT meu.id_emoney_user, meu.id_emoney, meu.nomor_emoney, meu.is_login, me.nama_emoney, me.status_emoney, meu.auth_emoney FROM master_emoney_user AS meu JOIN master_emoney AS me ON meu.id_emoney = me.id_emoney`;
